# Claude 실행 시 프로젝트 구조 가이드

---

## ⚠️ 필수 준수 사항 (반드시 숙지 후 시행)

**이 문서(CLAUDE.md)와 `.ai/skills/md-to-pptx/SKILL.md`의 내용을 반드시 전부 숙지한 후에만 작업을 시작한다.**
...
\*이 문서는 Claude 프로젝트를 이해하고 올바르게 실행할 수 있도록 작성되었습니다. **CLAUDE.md와 SKILL.md를 반드시 숙지한 후, 하나도 누락 없이 시행한다.\***
